    ...
    for i in list:
        ...
        if 'priority-1' in j or 'priority-2' in j or 'priority-3' in j:
            ...
            if '#' in name:
                ...
                write_sheet(b, j[0] + catalogue, name, demand_id, callout, step, result, case_type,
                            case_state, maker, creator)
            b += 1

if __name__ == '__main__':
    root = xmind_to_dict("C:/Users/92495/Desktop/test.xmind")[0]['topic']     # xmind文件路径
